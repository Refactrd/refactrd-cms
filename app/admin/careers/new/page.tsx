...
export default function NewCareerPage() {
  ...
  const addItem = (setter: Function, items: string[]) => {
    setter([...items, ''])
  }
  ...
  const saveCareer = async (status: 'draft' | 'open' | 'closed' | 'archived') => {
    if (!title.trim()) {
    ...
    if (!type.trim()) {
      toast({ title: 'Error', description: 'Please enter a job type', variant: 'destructive' })
      return
    }
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: `Job posting ${status === 'open' ? 'published' : 'saved as draft'}`,
        variant: 'success',
      })
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={() => saveCareer('open')} disabled={loading}>
            {loading ? (
              <Loader2 className="w-4 h-4 mr-2 animate-spin" />
            ) : (
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setAboutCompany, aboutCompany)}
            >
            ...
            <div key={index} className="flex gap-2">
              ...
              {aboutCompany.length > 1 && (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  onClick={() => removeItem(setAboutCompany, aboutCompany, index)}
                >
                  <X className="w-4 h-4" />
                </Button>
              )}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setRoleDescription, roleDescription)}
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Paragraph
            </Button>
            ...
            <div key={index} className="flex gap-2">
              ...
              {roleDescription.length > 1 && (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  onClick={() => removeItem(setRoleDescription, roleDescription, index)}
                >
                  <X className="w-4 h-4" />
                </Button>
              )}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setRequiredQualifications, requiredQualifications)}
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Item
            </Button>
            ...
            <div key={index} className="flex gap-2">
              ...
              {requiredQualifications.length > 1 && (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  onClick={() => removeItem(setRequiredQualifications, requiredQualifications, index)}
                >
                  <X className="w-4 h-4" />
                </Button>
              )}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setPreferredQualifications, preferredQualifications)}
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Item
            </Button>
          ...
          {preferredQualifications.map((item, index) => (
            <div key={index} className="flex gap-2">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                onClick={() => removeItem(setPreferredQualifications, preferredQualifications, index)}
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setBenefits, benefits)}
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Item
            </Button>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setRemuneration, remuneration)}
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Item
            </Button>
          ...
          {remuneration.map((item, index) => (
            <div key={index} className="flex gap-2">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                onClick={() => removeItem(setRemuneration, remuneration, index)}
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => addItem(setSuccessMetrics, successMetrics)}
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Item
            </Button>
          ...
          {successMetrics.map((item, index) => (
            <div key={index} className="flex gap-2">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                onClick={() => removeItem(setSuccessMetrics, successMetrics, index)}
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
